#' @title Efficient Estimation for biomarker studies in the two-phase sampling design.
#'
#' @description 'SL2Phase()' returns efficient estimation  for biomarker studies in the two-phase
