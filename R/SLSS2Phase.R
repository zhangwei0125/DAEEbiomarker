#' Efficient Estimation with sample splitting for biomarker studies in the two-phase sampling design.
#' 
#' 'SLSS2Phase()' returns efficient estimation with sample splitting for biomarker studies in the
