#' @title Estimating function with augmentation for the parameters of interest in two-phase design.
#'
#' @description 'psiStar()' is estimation function with augmentation in the two-phase design.
#'
#' @details This function is used to calculate the estimation function with augmentation in the two-phase design.
#'
